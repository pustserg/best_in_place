...
BestInPlaceEditor.prototype = {
  ...
  initOptions : function() {
    ...
    if (!self.element.attr("data-use-confirm")) {
      ...
      self.useConfirm = (self.element.attr("data-use-confirm") != "false" ? self.element.attr("data-use-confirm") : false);
    }
...
BestInPlaceEditor.forms = {
  ...
  "select" : {
    ...
    blurHandler : function(event) {
      var this_ = event.data.editor;
      var useConfirm = this_.useConfirm;
      var confirmStr = useConfirm !== 'true'
        ? useConfirm
        : "Are you sure you want to discard your changes?";

      if (useConfirm ? confirm(confirmStr) : true) {
        event.data.editor.update();
      } else {
        this_.abort();
      }
